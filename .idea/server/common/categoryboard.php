<?php
    ...
    $sql = "select boardid,userid,category.id,title,description,img,writedate,profileimage,nickname from boardwrite left join category on boardwrite.id = category.id where category.id = $i";
