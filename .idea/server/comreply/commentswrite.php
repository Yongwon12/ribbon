...
if(!$_POST->inherentid){
    ...
    if ($conn == null) {
        ...
        $sql1 = $conn->prepare("INSERT INTO comments(description,userid,nickname,categoryid,inherentid,
                     writedate,profileimage)
         VALUES (:description,:userid,:nickname,:categoryid,:inherentid,:writedate,:profileimage)");
        ...
        $sql2 =$conn->prepare("select commentcount,commentsid from boardwrite left join comments on boardwrite.boardid = comments.inherentid where boardid = :inherentid order by commentsid desc limit 1;");
