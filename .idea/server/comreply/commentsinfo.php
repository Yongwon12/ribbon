...
$sql = $conn-> prepare("select comments.description,comments.userid,comments.nickname,categoryid,inherentid,
       comments.writedate,comments.profileimage,comments.likedcount,commentsid,isrecomment,commentcount from 
boardwrite left join comments on comments.inherentid = boardwrite.boardid where boardid = :inherentid");
