...
$sql = $conn-> prepare("select groupcomments.description,groupcomments.userid,groupcomments.nickname,categoryid,inherentid,
       groupcomments.writedate,groupcomments.profileimage,groupcomments.likedcount,groupcommentsid,isrecomment,commentcount from 
groupwrite left join groupcomments on groupcomments.inherentid = groupwrite.groupid where groupid = :inherentid");
