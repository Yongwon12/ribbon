...
$sql = $conn-> prepare("select reply.description,reply.userid,reply.nickname,categoryid,inherentid,
       reply.writedate,reply.profileimage,reply.likedcount,replyid,isrecomment,inherentcommentsid,commentcount from 
boardwrite left join reply on reply.inherentid = boardwrite.boardid where boardid = :inherentid");
