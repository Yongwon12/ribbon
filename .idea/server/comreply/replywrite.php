...
if(!$_POST->inherentid){
    ...
    if ($conn == null) {
        ...
        $sql1 = $conn->prepare("INSERT INTO reply(description,profileimage,writedate,userid,nickname,categoryid,inherentid,
                     inherentcommentsid)
        ...
        $sql2 =$conn->prepare("select commentcount,replyid from boardwrite left join reply on boardwrite.boardid = reply.inherentid where boardid = :inherentid order by replyid desc limit 1;");
