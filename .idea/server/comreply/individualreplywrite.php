...
if(!$_POST->inherentid){
    ...
    if ($conn == null) {
        ...
        $sql1 = $conn->prepare("INSERT INTO individualreply(description,profileimage,writedate,userid,nickname,
        ...
        $sql3 = $conn->prepare("select individualreplyid from individualreply  order by individualreplyid desc limit 1");
        $sql3->execute();
