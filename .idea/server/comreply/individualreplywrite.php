...
if(!$_POST->inherentid){
    ...
    if ($conn == null) {
        ...
        $sql1 = $conn->prepare("INSERT INTO individualreply(description,profileimage,writedate,userid,nickname,inherentid,
                     inherentcommentsid)
        ...
        $sql2 =$conn->prepare("select commentcount,individualreplyid from individualwrite left join individualreply on individualwrite.individualid = individualreply.inherentid where individualid = :inherentid order by individualreplyid desc limit 1;");
