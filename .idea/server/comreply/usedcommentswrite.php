...
if(!$_POST->inherentid){
    ...
    if ($conn == null) {
        ...
        $sql1 = $conn->prepare("INSERT INTO usedcomments(description,userid,nickname,inherentid,
        ...
        $sql2 =$conn->prepare("select commentcount,usedcommentsid from 
        usedwrite left join usedcomments on usedwrite.usedid =
        usedcomments.inherentid where usedid = :inherentid order by usedcommentsid desc limit 1;");
