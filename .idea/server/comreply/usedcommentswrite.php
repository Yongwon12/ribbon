...
if(!$_POST->inherentid){
    ...
    if ($conn == null) {
        ...
        $sql1 = $conn->prepare("INSERT INTO usedcomments(description,userid,nickname,inherentid,writedate,
                     profileimage)
        ...
        $sql3 = $conn->prepare("select usedcommentsid from usedcomments  order by usedcommentsid desc limit 1");
        $sql3->execute();
