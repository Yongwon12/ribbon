...
$sql = $conn-> prepare("select groupreply.description,groupreply.userid,groupreply.nickname,categoryid,inherentid,
       groupreply.writedate,groupreply.profileimage,groupreply.likedcount,groupreplyid,isrecomment,inherentcommentsid,commentcount from 
groupwrite left join groupreply on groupreply.inherentid = groupwrite.groupid where groupid = :inherentid");
