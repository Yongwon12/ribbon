...
$individualreplyinfo = json_decode(file_get_contents("php://input"));
$conn = getConnection();
$sql = "select * from individualreply where inherentid='".$individualreplyinfo->inherentid."'";
$result = mysqli_query($conn, $sql);

$sql2 = "select commentcount from individualwrite where individualid = 
         '".$individualreplyinfo->inherentid."'";
